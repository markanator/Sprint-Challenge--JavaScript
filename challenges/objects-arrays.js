...
zooAnimals.map((item)=>{
  let i = `${item.animal_name.toLowerCase()}`;
  return lowCaseAnimalNames.push(i);
});

console.log("###LOWCASE "+lowCaseAnimalNames);
...
const lowPopulationAnimals = zooAnimals.filter(filtpop);

function filtpop(value){
